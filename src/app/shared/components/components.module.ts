...
import { HeaderClientComponent } from 'src/app/shared/components/header-client/header-client.component';
...
import { SectionFooterComponent } from 'src/app/shared/components/section-footer/section-footer.component';
