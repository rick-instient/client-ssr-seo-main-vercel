...
@Component({
  selector: 'app-heating_oil_prices',
  templateUrl: './heating_oil_prices.page.html',
  styleUrls: ['./heating_oil_prices.page.scss'],
})
export class HeatingOilPricesPage implements OnInit {
  ...
  fetchInit() {
    ...
    var title_ = "Today's BEST Heating Oil Prices | Search by ZIP | HeatFleet";
    var content_ =
      'Find the best current oil prices with our free, instant fuel oil price search. Local, trusted oil companies. Save up to $100 or more per oil delivery.';
    ...
    this.locationService
      ...
      .subscribe((responseList) => {
        ...
        // schema = this.clientbase.landing;
      });
