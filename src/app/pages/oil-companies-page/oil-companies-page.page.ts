...
@Component({
  selector: 'app-oil-companies-page',
  templateUrl: './oil-companies-page.page.html',
  styleUrls: ['./oil-companies-page.page.scss'],
})
export class OilCompaniesPage implements OnInit {
  public loaded = false;
