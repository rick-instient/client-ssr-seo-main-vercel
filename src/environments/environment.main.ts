...
export class DavosEnvironmentClass {
  ...
  public stage: DavosStaging = DavosStagings.Prod;
  ...
  protected localhost: DavosEnvironment = {
    ...
    //   id: 'GTM-MGKM89S',
    // },
    vendor_url: 'https://heatfleet-dev-vendor-hf.sigmanet.info/',
    temp_api_url: 'https://heatingoilfinder-dev-api-hf.sigmanet.info/',
    client_url: 'https://dev.heatrabbit.com/',
    secure_url: 'https://dev-secure.heatrabbit.com/',
    paypalClientId:
  ...
  protected uat: DavosEnvironment = {
    production: false,
    api_url: 'https://uat-api.heatrabbit.com/api/',
    ...
    //   id: 'G-H23CPLTTDD',
    // },
    vendor_url: 'https://heatfleet-uat-vendor-hf.sigmanet.info//',
    temp_api_url: 'https://heatingoilfinder-dev-api-hf.sigmanet.info/',
    client_url: 'https://uat.heatrabbit.com/',
    secure_url: 'https://uat-secure.heatrabbit.com/',
    paypalClientId:
      'AVd9gVKUYrf1BAU0M2gRAebZcl4IH7G_FZ4_HsW_YGD1WXHagnH7J5EGvS7GS2KNY680njuGYmEH7rAR',
  };
  protected main: DavosEnvironment = {
    production: false,
    api_url: 'https://api.heatrabbit.com/api/',
    ...
    //   id: 'G-H23CPLTTDD',
    // },
    vendor_url: 'https://dealer.heatfleet.com/',
    temp_api_url: 'https://api.heatingoilfinder.com/',
    client_url: 'https://heatrabbit.com/',
    secure_url: 'https://secure.heatrabbit.com/',
    paypalClientId:
      'AVd9gVKUYrf1BAU0M2gRAebZcl4IH7G_FZ4_HsW_YGD1WXHagnH7J5EGvS7GS2KNY680njuGYmEH7rAR',
  };
}
